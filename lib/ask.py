...
def ask_for_vector_response(service_context, collection, question) -> str:
    return get_vector_query_engine(service_context, collection).query(question).response
...
def ask_hybrid_query_engine(service_context, query_engine_options, doc_sum_index_dir, collection, g_db, question) -> Response:
    return get_hybrid_query_engine(service_context, query_engine_options, doc_sum_index_dir, collection, g_db).query(question)